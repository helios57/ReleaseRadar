...
// Rollout types — each one carries its cascade plan and inherited task list.
// cascadePlan is an ordered list of stages with day-offsets from the start.
//   A single-entry plan means "single-stage" (no cascade).
//   Add a 4th, 5th stage simply by appending — the UI is data-driven.
